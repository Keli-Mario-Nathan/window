...
const snowPane = new Snow(60, 300, 183, 4, 86, 2, 6, 3, 5, 2, 20, 9, 12, 190, 0, 90, 210, 20, 100);
const cloudPane = new Clouds(100, 200, 212, 79, 73, 0.1, 2, 0.2, 0.7, 100, 300, 130, 260, 200, 0, 90, 220, 10, 100);
...
$(function() {
    $('#component-light-slider').slider({
        ...
        change: function(event, ui) {
            ...
            scene.color.lightness.lower = ui.values[1];
        }
    });
});